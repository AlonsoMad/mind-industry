...
if __name__ == "__main__":
    ...
    # ---------- Final preparation with DataPreparer ----------

prep = DataPreparer(
    path_folder=str(output_dir),  # where segmented/translated parquets live
    name_anchor=f"{args.base_name}_trans_s{args.seed_lang}_t{args.target_lang}_n{args.ndocs}.parquet.gzip",
    name_target=f"{args.base_name}_trans_s{args.target_lang}_t{args.seed_lang}_n{args.ndocs}.parquet.gzip",
    storing_path=str(output_dir),  # where to save polylingual_df.parquet
